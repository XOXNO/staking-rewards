    ...
    return (
        <div className={cn("p-4 border rounded-lg bg-card text-card-foreground shadow-sm", className)}>
            ...
            <div className="flex gap-2 mb-3">
                 <Button variant="outline" size="xs" onClick={handleSelectAll} disabled={selectedAddresses.length === addedAddresses.length}>Select All</Button>
                 <Button variant="outline" size="xs" onClick={handleDeselectAll} disabled={selectedAddresses.length === 0}>Deselect All</Button>
            </div>
