...
export default function HomePage(): React.ReactElement {
  ...
  const { globalStats, aggregatedEpochData, epochWalletData, walletColorMap, allProvidersData, allProviderOwners } = useMemo(() => {
      ...
      const hasDataForAllSelected = selectedAddresses.every(addr => relevantRewardsData[addr] !== undefined && !relevantLoadingStates[addr]);
               ...
               <div className="flex-1 overflow-y-auto bg-muted/30">
                   {selectedAddresses.length === 0 ? (
                       ...
                       <div className="flex flex-1 items-center justify-center text-destructive p-4 text-center">
                           Error fetching data for {shortenAddress(anyError)}: {String(error[anyError])}
                       </div>
                       ...
                       selectedAddresses.some(addr => rewardsData[addr]) ? (
                           ...
                           <div className="flex items-center justify-center h-full text-muted-foreground">
                               {isAnyLoading ? 'Loading provider data...' : 'No data for this provider and selected wallet(s).'}
                           </div>
                       )
                   )}
               </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-12">
          ...
          <section className="text-center mb-16 md:mb-24 pt-8 md:pt-12">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4">
                  Unified <span className="text-primary">EGLD</span> Staking Rewards Dashboard
              </h1>
          ...
          <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                  ...
                  <Card className="text-center transition-transform duration-200 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.025]">
                      ...
                      <CardContent>
                          <CardDescription>
                              Connect all your wallets and view combined statistics and rewards history in one unified interface.
                          </CardDescription>
                      </CardContent>
                  </Card>
                  {/* Feature 2 */}
                  <Card className="text-center transition-transform duration-200 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.025]">
                      ...
                      <CardContent>
                          <CardDescription>
                              Drill down into specific staking providers. See epoch-by-epoch rewards and performance metrics.
                          </CardDescription>
                      </CardContent>
                  </Card>
                  {/* Feature 3 */}
                  <Card className="text-center transition-transform duration-200 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.025]">
                      ...
                      <CardContent>
                          <CardDescription>
                              Interactive charts help you easily understand reward trends, distribution, and performance over time.
                          </CardDescription>
                      </CardContent>
                  </Card>
                   {/* Feature 4 */}
                  <Card className="text-center transition-transform duration-200 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.025]">
                      ...
                      <CardContent>
                          <CardDescription>
                              Fetches reward information directly from the MultiversX blockchain via trusted API providers.
                          </CardDescription>
                      </CardContent>
                  </Card>
                   {/* Feature 5 */}
                  <Card className="text-center transition-transform duration-200 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.025]">
                      ...
                      <CardContent>
                          <CardDescription>
                             Get a high-level view of total rewards, average earnings, and performance across all connected wallets.
                          </CardDescription>
                      </CardContent>
                  </Card>
                   {/* Feature 6 */}
                  <Card className="text-center transition-transform duration-200 hover:shadow-lg hover:-translate-y-1 hover:scale-[1.025]">
                      ...
                      <CardContent>
                          <CardDescription>
                              Easily navigate your staking data with a modern, intuitive, and responsive user interface.
                          </CardDescription>
                      </CardContent>
                  </Card>
              </div>
